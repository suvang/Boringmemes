...
<header>
	<div class="logo"> <a class="navbar-brand" href="index.php"><h2 style="padding: 4px 1px 2px 2px;; color: #fff">BoringMEMES </h2></a></div>
	<nav >
		<ul>
...
<section class="blog" id="blog">
		...
		<div class="row">
			<div class="offset-sm-2 col-sm-8">
				<div class="headerText text-center">
					<h2>WATCH & REPLAY</h2>
					<hr>
					<p>Browse through funny video's and clips.
					</p>
				</div>
			</div>
		</div>
  ...
  <?php
  $con = mysqli_connect("sql201.epizy.com", "epiz_24360053", "m2K6ftk5Z5CRq", "epiz_24360053_photos");
  ...
  $result = mysqli_query($con, $sql);
	...
	echo "<div class='col-sm-12 text-center'>";
	 echo "<div class='blogpost'>";
      ...
      echo "<video  playsinline   controls = 'true' style='border: solid 3px #000; padding: 3px;'  width='50%' height='50%' controls='true' poster='poster/".$row['poster']."' >";
      	echo "<source src='".$row['video'].'/'.$row['video1'].'/'.$row['video2']."' type='video/mp4'  class='img-fluid' >";
      	echo "</video>";
      	echo "</div>";
      	echo "<div class='content'>
		<h1>Post by BoringMEMES</h1>
		<p>@Copyright 2019</p>";
	  echo "</div>";
      echo "</div>";
      echo "<br>";
