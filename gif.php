...
<section class="blog" id="blog">
		...
		<div class="row">
			<div class="offset-sm-2 col-sm-8">
				<div class="headerText text-center">
					<h2>WATCH & REPLAY</h2>
					<hr>
					<p>Browse and find your favourite GIF.
					</p>
				</div>
			</div>
		</div>
  ...
  $sql = "SELECT * FROM gifs order by id desc";
  $result = mysqli_query($con, $sql);
	...
	echo "<div class='col-sm-12 text-center'>";
     ...
     echo "<div class='gif'>";
      	echo "<img  style='border: solid 3px #000; padding: 3px;'   src='".$row['gif'].'/'.$row['gif1'].'/'.$row['gif2']."'  class='img-fluid' >";
      	echo "</img>";
      	echo "</div>";
      	echo "</div>";
